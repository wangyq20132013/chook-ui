<template>
	<view>
		<picker mode="multiSelector" :range="dates" :value="value" @change="confirm" @columnchange="scroll" @cancel="cancel"
		 :disabled="disabled">
			<slot></slot>
		</picker>
	</view>
					...
					case 'date':
						{
							...
							date = {
								...
								month,
								day,
								key: this.years[value[0]].substring(0, 4) + '-' + (month.length == 1 ? '0' + month : month) + '-' + (day.length ==
									1 ? '0' + day : day),
					...
					case 'yearToMinute':
						{
							...
							date = {
								...
								minute,
								key: this.years[value[0]].substring(0, 4) + '-' + (month.length == 1 ? '0' + month : month) + '+' + (day.length ==
									1 ? '0' + day : day) + ' ' + (hour.length == 1 ? '0' + hour : hour) + ':' + (minute.length == 1 ? '0' +
									minute : minute),
								value: this.years[value[0]] + this.months[value[1]] + this.days[value[2]] + this.hours[value[3]] + this.minutes[
									value[4]]
							}
						}
						break;
					default:
						{
							...
							date = {
								...
								key: this.years[value[0]].substring(0, 4) + '-' + (month.length == 1 ? '0' + month : month) + '-' + (day.length ==
									1 ? '0' + day : day) + ' ' + (hour.length == 1 ? '0' + hour : hour) + ':' + (minute.length == 1 ? '0' +
									minute : minute) + ':' + (second.length == 1 ? '0' + second : second),
								value: this.years[value[0]] + this.months[value[1]] + this.days[value[2]] + this.hours[value[3]] + this.minutes[
									value[4]] + this.seconds[value[5]]
							}
						}
						break;
				}
					...
					case '12':
						{
							...
							if (parseInt(this.beginYear) == parseInt(this.year) && parseInt(this.endYear) == parseInt(this.year) && parseInt(this.beginMonth) == parseInt(this.month) && parseInt(this.endMonth) ==
								parseInt(this.month)) {
								for (var i = parseInt(this.beginDay); i <= parseInt(this.endDay); i++) {
									this.days.push(i + '日');
								}
							} else if (
								(parseInt(this.beginYear) == parseInt(this.year) && parseInt(this.endYear) == parseInt(this.year) && parseInt(this.beginMonth) == parseInt(this.month)) ||
					...
					case '2':
						{
							if ((parseInt(this.year) % 4 == 0 && parseInt(this.year) % 100 != 0) || parseInt(this.year) % 400 == 0) {
								...
								if (parseInt(this.beginYear) == parseInt(this.year) && parseInt(this.endYear) == parseInt(this.year) && parseInt(this.beginMonth) == parseInt(this.month) && parseInt(this.endMonth) ==
									...
									(parseInt(this.beginYea) == parseInt(this.year) && parseInt(this.endYear) == parseInt(this.year) && parseInt(this.endMonth) == parseInt(this.month)) ||
									(parseInt(this.endYear) <= parseInt(this.year) && parseInt(this.endMonth) == parseInt(this.month))
								) {
									for (var i = 1; i <= parseInt(this.endDay); i++) {
										this.days.push(i + '日');
